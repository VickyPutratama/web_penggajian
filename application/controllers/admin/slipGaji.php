<?php 
 ...
 class SlipGaji extends CI_Controller{
 	...
 	public function cetakSlipGaji()
 	{
        ...
        $data['print_slip'] = $this->db->query("SELECT data_pegawai.nama_pegawai,data_pegawai.nik,data_jabatan.nama_jabatan,data_jabatan.gaji_pokok,data_jabatan.tj_transport,data_jabatan.uang_makan,data_kehadiran.alpha
        	FROM data_pegawai
